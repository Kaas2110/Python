...
#     def __init__(self, _length, _width, volume, score):
...
#     def score_asph(self):
#         mas = Road.mass(self)
#         return mas * self.volume * self.score
#
#
#
#
#
# r = MassCount(3, 137, 120, 5)
# print((r.score_asph()) / 1000, "тонн")
...
class Pen(Stationery):
    ...
    def draw(self):
        return f'вы взяли в руки {self.title}. Запуск отрисовки'
...
class Pencil(Stationery):
    def __init__(self, title, color):
        ...
        self.color = color
    def draw(self):
        return f'Вы взяли в руки {self.title}. Запуск отрисовки {self.color} цвета'

class Handle(Stationery):
    def __init__(self, title):
        super().__init__(title)
    def draw(self):
        return f'Вы взяли в руку {self.title}. Запуск отрисовки'

pen = Pen('Ручка')
pencil = Pencil('Карандаш', 'blue')
